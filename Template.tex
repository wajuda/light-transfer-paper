...
\end{aligned}
\end{equation}
without any additional learnable parameters. Each extractor $\mathcal{E}$ consists of three stacked $3 \times 3$ convolutional layers; the second layer uses a dilated convolution to enlarge the receptive field while keeping the spatial resolution unchanged.
