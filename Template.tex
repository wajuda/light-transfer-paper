...
\end{aligned}
\end{equation}
without any additional learnable parameters. Each extractor $\mathcal{E}$ contains three convolutional blocks: a $1 \times 1$ convolution that projects the channels to a low-dimensional space, followed by two $3 \times 3$ convolutions (the second one being dilated to enlarge the receptive field) that refine the spatial structure, and a final $1 \times 1$ convolution that projects the channels back.
