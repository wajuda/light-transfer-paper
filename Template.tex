...
\hline
Zero-DCE++      & 59.60 & 0.438 & \underline{0.371} & 4.29 & 73.24 & 20.35 & \underline{3.00} & \underline{2.15} & 20.27 \\
\hline
...
Reti-Diff       & \underline{62.49} & \underline{0.469} & \textbf{0.391} & \underline{4.39} & \underline{78.19} & 21.32 & 3.46 & 2.52 & 24.54 \\
...
\hline
Ours (6.1, gain\_max=2.0) & \textbf{63.13} & 0.472 & 0.372 & 4.38 & \textbf{79.23} & \textbf{19.64} & \textbf{2.91} & \textbf{2.03} & \underline{19.83} \\
\hline
\end{tabular}
\end{table*}
